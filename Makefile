...
REGISTRY ?= quay.io
REG = $(REGISTRY)/$(ORG)
REPOS = perfapp  etcd-perf nginx nginx-ssh frr netpol-scraper nginxecho eipvalidator sampleapp netpolvalidator netpolproxy convergencetracker foreman-cli
